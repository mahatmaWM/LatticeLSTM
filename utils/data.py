...
class Data:
    ...
    def build_alphabet(self, input_file):
        '''
        读取train、dev、test数据，得到其中的数据的字，词，bigram，label等一系列信息
        并得到标注体系信息
        :param input_file:
        :return:
        '''
    ...
    def build_gaz_file(self, gaz_file):
        '''
        一份词典信息，可以理解成包含了字词的一些边界信息
        https://stackoverflow.com/questions/34995139/nlp-is-gazetteer-a-cheat

        A gazetteer consists of a set of lists containing names of entities such as cities, organisations, days of the week, etc.
        These lists are used to ﬁnd occurrences of these names in text, e.g. for the task of named entity recognition.
        :param gaz_file:
        :return:
        '''
    ...
    def build_biword_pretrain_emb(self, emb_path):
        ...
        self.pretrain_biword_embedding, self.biword_emb_dim = build_pretrain_embedding(emb_path,
