...
#python main.py --status train --train ./data/music.play.train --dev ./data/music.play.dev --test ./data/music.play.test --savemodel ./data/music-play > ./music-play.log 2>&1 &

# python2 main.py --status decode --raw ../data/onto4ner.cn/demo.test.char --savedset ../data/onto4ner.cn/demo.dset --loadmodel ../data/onto4ner.cn/demo.0.model --output ../data/onto4ner.cn/demo.raw.out
